...
function setupRandomAudioPlayer() {
    const pageSongs = {
        ...
        "index.html": "/old/media/nyan.mp3",
        "home.html": "/old/media/nyan.mp3", // Assuming home.html might be used too
        "about.html": "/old/media/antonympth.mp3",
        "blog.html": "/old/media/spookwave.mp3",
        "socials.html": "/old/media/you-deer.mp3",
        "minecraft.html": "/old/media/stal.mp3"
    };

    const currentPage = getCurrentPage();
    // Provide a default even if getCurrentPage fails somehow
    const audioSrc = pageSongs[currentPage] || "/old/media/nyan.mp3";
